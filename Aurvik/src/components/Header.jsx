...
import OrientationFormModal from "./OrientationFormModal"; // ✅ Import the popup form

const Header = () => {
  const [isResourcesOpen, setIsResourcesOpen] = useState(false);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  const [isMobileResourcesOpen, setIsMobileResourcesOpen] = useState(false);
  const [isFormOpen, setIsFormOpen] = useState(false); // ✅ popup form control
  ...
  return (
    <>
      ...
      <header className="flex justify-between items-center px-6 sm:px-8 py-4 bg-white shadow-sm relative z-50">
        ...
        {/* ---------- Desktop CTA Button ---------- */}
        <button
          className="hidden md:block bg-blue-900 text-white px-5 py-2 rounded-md hover:bg-blue-800 transition"
          onClick={() => setIsFormOpen(true)} // ✅ open popup
        >
        ...
        >
          ...
          <div className="flex flex-col px-6 py-4 space-y-4 text-gray-800 font-medium">
            ...
            <button
              ...
              onClick={() => {
                handleLinkClick();
                setIsFormOpen(true); // ✅ open form from mobile too
              }}
            >
              Join Free Orientation
            </button>
